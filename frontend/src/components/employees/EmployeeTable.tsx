  ...
  if (employees.length === 0) {
    return (
      <EmptyState
        ...
        description="Add your first person to start tracking their time with AttendPro."
      />
    );
  }
        ...
        <table className="w-full text-left">
          <thead>
            <tr className="bg-gray-50 border-b border-gray-100">
              ...
              <th className="table-th">Team &amp; role</th>
              <th className="table-th">Contact</th>
              <th className="table-th text-center">Days present</th>
