        ...
        <div className="flex items-center justify-between h-16 px-5 border-b border-gray-100">
          <div className="flex items-center gap-2.5">
            ...
            <div className="leading-tight">
              <p className="text-sm font-bold text-gray-900">AttendPro</p>
              <p className="text-[10px] text-gray-400 font-medium uppercase tracking-wider">Attendance & HR Portal</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-4 border-t border-gray-100">
          <div className="flex items-center gap-3 px-2">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[11px] text-gray-400 truncate">admin@attendpro.app</p>
            </div>
          </div>
        </div>
      </aside>
