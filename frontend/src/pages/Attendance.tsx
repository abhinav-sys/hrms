  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          <h2 className="text-xl font-bold text-gray-900">Time logboard</h2>
          ...
          {counts.map(({ label, count, color, bg }) => (
            <div key={label} className={`card p-4 flex items-center gap-3 ${bg} border-0`}>
              ...
              <div>
                ...
                <p className={`text-xs ${color} opacity-70`}>{label} logs</p>
              </div>
            </div>
          ))}
        </div>
      ...
      <div className="card p-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          {/* Employee */}
          <div>
            <label className="form-label text-xs">Person</label>
            <div className="relative">
